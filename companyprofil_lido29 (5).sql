...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Des 2023 pada 04.42
...
INSERT INTO `banner_img` (`id`, `image`, `text`, `sub`) VALUES
(6, 'IL26WB.jpg', 'Sang Juara', 'Lido Grosir');
...
(1, '<p>Menjadi perusahaan penyedia solusi kebutuhan masyarakat yang berskala nasional dengan mengedepankan teknologi informasi dan komunikasi yang cepat fokus dan fleksibel.</p>\r\n', '<p>1. Menghasilkan laba yang pantas untuk mendukung pengembangan perusahaan.</p>\r\n\r\n<p>2. Menyediakan berbagai jenis produk FMCG dan pendukungnya sebagai solusi yang sesuai dengan kebutuhan industri pemerintah dan masyarakat ', '3LV65P.png');
