                    ...
                    <div class="table-responsive">
                      <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('service/edit/'. $service['id_service']) ?>" class="btn btn-success btn-sm" > <i class="mdi mdi-lead-pencil"></i></a>
                                <a href="<?php echo base_url('service/hapus_service/' . $service['id_service']); ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus layanan ini?')"  class="btn btn-danger btn-sm"><i class="mdi mdi-backspace" ></i></a>
                            </td>
                        </tr>
                        </tbody>
                            <?php endforeach; ?>
